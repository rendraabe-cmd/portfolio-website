        ...
        <div class="relative z-10 max-w-6xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-12 items-center">
            ...
            <div class="text-center md:text-left order-2 md:order-1">
                ...
                <div class="flex gap-4 justify-center md:justify-start">
                    ...
                    <a href="https://github.com/rendraabe-cmd/mini-pos-backend" target="_blank"
                        class="p-3 bg-white dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg shadow-md transition-all hover:-translate-y-0.5"
            ...
            <div class="grid md:grid-cols-5 gap-12 items-center">
                ...
                <div class="md:col-span-2 grid grid-cols-2 gap-4">
                    ...
                    <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-xl hover:-translate-y-1 transition-all">
                        ...
                        <div class="text-sm text-gray-600 dark:text-gray-400 mt-1">Live Projects</div>
                    </div>

                    <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-xl hover:-translate-y-1 transition-all">
                        <div class="text-4xl mb-2">⚡</div>
                        <div class="text-3xl font-bold text-pink-600 dark:text-pink-400">20+</div>
                        <div class="text-sm text-gray-600 dark:text-gray-400 mt-1">API Endpoints</div>
                    </div>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-all">
                    ...
                    <div class="flex flex-wrap gap-3">
                        ...
                        <span class="px-4 py-2 bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded-lg font-medium text-sm hover:scale-105 transition-transform">Vue.js 3</span>
                        ...
                        <span class="px-4 py-2 bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 rounded-lg font-medium text-sm hover:scale-105 transition-transform">Pinia</span>
                        <span class="px-4 py-2 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded-lg font-medium text-sm hover:scale-105 transition-transform">Bootstrap</span>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-all">
                    ...
                    <div class="flex flex-wrap gap-3">
                        ...
                        <span class="px-4 py-2 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg font-medium text-sm hover:scale-105 transition-transform">SQLite</span>
                ...
                <div class="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-all">
                    ...
                    <div class="flex flex-wrap gap-3">
                        ...
                        <span class="px-4 py-2 bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded-lg font-medium text-sm hover:scale-105 transition-transform">Vercel</span>
                        ...
                        <span class="px-4 py-2 bg-red-50 dark:bg-red-900/30 text-red-700 dark:text-red-300 rounded-lg font-medium text-sm hover:scale-105 transition-transform">Nginx</span>
                        <span class="px-4 py-2 bg-pink-50 dark:bg-pink-900/30 text-pink-700 dark:text-pink-300 rounded-lg font-medium text-sm hover:scale-105 transition-transform">Supervisord</span>
    ...
    <section id="projects" class="py-20 md:py-32">
        <div class="max-w-6xl mx-auto px-6">
            ...
            <div class="space-y-12">
                        ...
                        <div class="p-8 md:p-12 flex flex-col justify-center">
                            ...
                            <ul class="space-y-2 mb-6 text-sm text-gray-700 dark:text-gray-300">
                                ...
                                <li class="flex items-start gap-2">
                                    ...
                                    SSL-secured cloud database (Aiven)
                                </li>
                                <li class="flex items-start gap-2">
                                    <svg class="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                            ...
                            <div class="flex flex-wrap gap-3">
                                <a href="https://task-management-api-6390.onrender.com" target="_blank"
                ...
                <!-- PROJECT 2: MINI POS FULLSTACK -->
                <div class="group bg-white dark:bg-gray-800 rounded-3xl overflow-hidden shadow-xl border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-all">
                    <div class="grid md:grid-cols-2 gap-0">

                        <!-- Left: Visual -->
                        <div class="relative bg-gradient-to-br from-emerald-500 via-teal-600 to-cyan-700 p-8 md:p-12 flex items-center justify-center overflow-hidden order-1">
                            <div class="absolute top-0 right-0 w-64 h-64 bg-white/10 rounded-full blur-3xl"></div>
                            <div class="absolute bottom-0 left-0 w-64 h-64 bg-black/20 rounded-full blur-3xl"></div>

                            <div class="relative z-10 w-full max-w-md bg-gray-900 rounded-xl shadow-2xl overflow-hidden">
                                <div class="flex items-center gap-2 px-4 py-3 bg-emerald-800 border-b border-emerald-700">
                                    <div class="w-3 h-3 bg-red-500 rounded-full"></div>
                                    <div class="w-3 h-3 bg-yellow-500 rounded-full"></div>
                                    <div class="w-3 h-3 bg-green-500 rounded-full"></div>
                                    <span class="ml-2 text-emerald-200 text-xs font-mono">Mini POS — Kasir</span>
                                </div>
                                <div class="p-4 font-mono text-xs space-y-2">
                                    <div class="flex justify-between text-gray-300">
                                        <span class="text-emerald-400">🛒 Cart</span>
                                        <span class="text-yellow-400">3 items</span>
                                    </div>
                                    <div class="border-t border-gray-700 pt-2 space-y-1">
                                        ...
                                        <div class="flex justify-between text-gray-400">
                                            <span>Croissant</span>
                                            <span class="text-white">Rp 18.000</span>
                                        </div>
                                        <div class="flex justify-between text-gray-400">
                                            <span>Mineral Water</span>
                                            <span class="text-white">Rp 8.000</span>
                                        </div>
                                    </div>
                                    <div class="border-t border-gray-700 pt-2 flex justify-between font-bold">
                                        <span class="text-emerald-400">TOTAL</span>
                                        <span class="text-emerald-400">Rp 51.000</span>
                                    </div>
                                    <div class="mt-2 bg-emerald-600 text-center py-1.5 rounded text-white text-xs font-bold tracking-wider">
                                        ✓ BAYAR SEKARANG
                                    </div>
                                </div>
                            </div>
                        ...
                        <!-- Right: Content -->
                        <div class="p-8 md:p-12 flex flex-col justify-center order-2">
                            <div class="flex items-center gap-2 mb-4">
                                <span class="inline-flex items-center gap-2 px-3 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 rounded-full text-xs font-semibold">
                                    <span class="w-2 h-2 bg-green-500 rounded-full animate-pulse"></span>
                                    LIVE
                                </span>
                                <span class="px-3 py-1 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 rounded-full text-xs font-semibold">
                                    FULLSTACK
                                </span>
                            </div>
                            ...
                            <p class="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                                A complete fullstack Point of Sale application with role-based access control,
                                real-time cart management, transaction history, and receipt generation.
                                Backend API + Vue.js SPA deployed separately to production.
                            </p>

                            <div class="flex flex-wrap gap-2 mb-6">
                                <span class="px-3 py-1 bg-red-50 dark:bg-red-900/30 text-red-700 dark:text-red-300 text-xs font-semibold rounded">Laravel 11</span>
                                <span class="px-3 py-1 bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-300 text-xs font-semibold rounded">Vue.js 3</span>
                                <span class="px-3 py-1 bg-yellow-50 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-300 text-xs font-semibold rounded">Pinia</span>
                                <span class="px-3 py-1 bg-sky-50 dark:bg-sky-900/30 text-sky-700 dark:text-sky-300 text-xs font-semibold rounded">Tailwind CSS</span>
                                <span class="px-3 py-1 bg-pink-50 dark:bg-pink-900/30 text-pink-700 dark:text-pink-300 text-xs font-semibold rounded">Sanctum</span>
                                <span class="px-3 py-1 bg-cyan-50 dark:bg-cyan-900/30 text-cyan-700 dark:text-cyan-300 text-xs font-semibold rounded">Docker</span>
                                <span class="px-3 py-1 bg-teal-50 dark:bg-teal-900/30 text-teal-700 dark:text-teal-300 text-xs font-semibold rounded">SQLite</span>
                            </div>
                            ...
                            <ul class="space-y-2 mb-6 text-sm text-gray-700 dark:text-gray-300">
                                ...
                                <li class="flex items-start gap-2">
                                    ...
                                    Cart system + receipt generation
                                </li>
                                <li class="flex items-start gap-2">
                                    <svg class="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                ...
                                <li class="flex items-start gap-2">
                                    ...
                                    Decoupled API + Vue SPA architecture
                                </li>
                            </ul>

                            <div class="flex flex-wrap gap-3">
                                <a href="https://mini-pos-frontend-mini-pos-frontend-808z.onrender.com" target="_blank"
                                    class="inline-flex items-center gap-2 px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold rounded-lg shadow-md hover:shadow-lg transition-all">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/>
                                    </svg>
                                    Live Demo
                                ...
                                <a href="https://github.com/rendraabe-cmd/mini-pos-frontend" target="_blank"
                                    class="inline-flex items-center gap-2 px-5 py-2.5 bg-gray-700 dark:bg-gray-600 hover:bg-gray-600 dark:hover:bg-gray-500 text-white font-semibold rounded-lg shadow-md hover:shadow-lg transition-all">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/>
                                    </svg>
                                    Frontend Repo
                ...
                <div class="group bg-white dark:bg-gray-800 rounded-3xl overflow-hidden shadow-xl border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-all">
                    <div class="grid md:grid-cols-2 gap-0">
                        ...
                        <div class="p-8 md:p-12 flex flex-col justify-center order-2 md:order-1">
                            ...
                            <p class="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                                A professional portfolio website with dark mode, smooth animations,
                                and a fully functional contact form powered by Resend API.
                                Built with Laravel 11 Blade + Alpine.js + Tailwind CSS.
                            </p>

                            <div class="flex flex-wrap gap-2 mb-6">
                                <span class="px-3 py-1 bg-red-50 dark:bg-red-900/30 text-red-700 dark:text-red-300 text-xs font-semibold rounded">Laravel 11</span>
                                <span class="px-3 py-1 bg-sky-50 dark:bg-sky-900/30 text-sky-700 dark:text-sky-300 text-xs font-semibold rounded">Tailwind CSS</span>
                                <span class="px-3 py-1 bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 text-xs font-semibold rounded">Alpine.js</span>
                                <span class="px-3 py-1 bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-300 text-xs font-semibold rounded">Resend API</span>
                                <span class="px-3 py-1 bg-teal-50 dark:bg-teal-900/30 text-teal-700 dark:text-teal-300 text-xs font-semibold rounded">SQLite</span>
                                <span class="px-3 py-1 bg-cyan-50 dark:bg-cyan-900/30 text-cyan-700 dark:text-cyan-300 text-xs font-semibold rounded">Docker</span>
                            </div>
                            ...
                            <div class="flex flex-wrap gap-3">
                                <a href="https://portfolio-website-r9h4.onrender.com" target="_blank"
                                    class="inline-flex items-center gap-2 px-5 py-2.5 bg-purple-600 hover:bg-purple-700 text-white font-semibold rounded-lg shadow-md hover:shadow-lg transition-all">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/>
                                    </svg>
                                    Live Demo
                                </a>
                                <a href="https://github.com/rendraabe-cmd/portfolio-website" target="_blank"
                                    class="inline-flex items-center gap-2 px-5 py-2.5 bg-gray-900 dark:bg-gray-700 hover:bg-gray-800 dark:hover:bg-gray-600 text-white font-semibold rounded-lg shadow-md hover:shadow-lg transition-all">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/>
                                    </svg>
                        ...
                        <div class="relative bg-gradient-to-br from-purple-500 via-indigo-600 to-blue-700 p-8 md:p-12 flex items-center justify-center overflow-hidden order-1 md:order-2">
                            <div class="absolute top-0 right-0 w-64 h-64 bg-white/10 rounded-full blur-3xl"></div>
                            <div class="absolute bottom-0 left-0 w-64 h-64 bg-black/20 rounded-full blur-3xl"></div>
                            ...
                            <div class="relative z-10 w-full max-w-md bg-gray-900 rounded-xl shadow-2xl overflow-hidden">
                                <div class="flex items-center gap-2 px-4 py-3 bg-gray-800 border-b border-gray-700">
                                    ...
                                    <div class="w-3 h-3 bg-yellow-500 rounded-full"></div>
                                    <div class="w-3 h-3 bg-green-500 rounded-full"></div>
                                    <span class="ml-2 text-gray-400 text-xs font-mono">portfolio-website.onrender.com</span>
                                </div>
                                <div class="p-4 font-mono text-xs space-y-2">
                                    <div class="text-purple-400 text-sm font-bold">👋 Hi, I'm Rendra</div>
                                    <div class="text-gray-400 text-xs">Fullstack Web Developer</div>
                                    <div class="border-t border-gray-700 pt-2 space-y-1.5">
                                        <div class="text-green-400">✉ Contact form → Resend API</div>
                                        <div class="text-cyan-400">🌙 Dark / Light mode</div>
                                        <div class="text-yellow-400">📱 Fully responsive</div>
                                        <div class="text-pink-400">🚀 Live on Render.com</div>
                                        <div class="text-indigo-400">🐳 Dockerized deploy</div>
                                    </div>
                                </div>
                            </div>
                        </div>
